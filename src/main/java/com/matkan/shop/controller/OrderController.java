...
import com.matkan.shop.service.OrderService;
...
public class OrderController {
    ...
    public String increaseItems(@PathVariable("itemId") Long itemId  )
    {
    ...
    public String decreaseItems(@PathVariable("itemId") Long itemId  )
    {
    ...
    public String removeItemsCart(@PathVariable("itemId") Long itemId){
